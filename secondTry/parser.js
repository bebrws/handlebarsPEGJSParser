...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = peg$otherExpectation("sexp"),
      peg$c1 = "(",
      ...
      peg$c11 = function(expr) { return "Command: " + expr; },
  ...
  function peg$parseExpression() {
    ...
    s0 = [];
    s1 = peg$parseCommandOrStringWoCommand();
    while (s1 !== peg$FAILED) {
      s0.push(s1);
      s1 = peg$parseCommandOrStringWoCommand();
    }
  ...
  function peg$parseCommandOrStringWoCommand() {
    var s0;
